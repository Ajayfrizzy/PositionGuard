...
| 2. Deterministic engine   | src/lib/aave/{types,calculations}.ts, src/lib/protection/_, src/lib/policies/_, tests/unit/                                                                                                  | Required risk, MEI, policy, boundary, precision, disabled-action, daily-limit and cooldown tests pass              |
