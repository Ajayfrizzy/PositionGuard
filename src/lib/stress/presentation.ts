...
export function recoveryTransition(stressedHealthFactor: string | null, recoveredHealthFactor: string | null) { return { before: { label: "Before protection", healthFactor: stressedHealthFactor }, after: { label: "After protection", healthFactor: recoveredHealthFactor } }; }
