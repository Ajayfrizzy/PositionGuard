...
export const baseConfig = {
  chainId: 8453, name: "Base mainnet", testnet: false, rpcEnvKey: "BASE_RPC_URL",
  ...
  blockExplorerBaseUrl: "https://basescan.org", keeperHubSupported: true,
} as const satisfies ChainConfig;
export const baseSepoliaConfig = {
  chainId: 84532, name: "Base Sepolia", testnet: true, rpcEnvKey: "BASE_SEPOLIA_RPC_URL",
  ...
  blockExplorerBaseUrl: "https://sepolia.basescan.org", keeperHubSupported: true,
} as const satisfies ChainConfig;
...
export function getDefaultChain(env: Readonly<Record<string, string | undefined>> = process.env): ChainConfig {
  ...
  try { return getChain(Number(raw)); } catch { throw new Error("INVALID_DEFAULT_CHAIN"); }
}
