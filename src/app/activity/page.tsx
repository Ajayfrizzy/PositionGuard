...
export default async function ActivityPage() {
  ...
  return (
    <div className="page">
      ...
      >
        <StatusPill tone="blue">{events.length} EVENTS</StatusPill>
      </PageHeader>
      {latest && (
                ...
                <div className="audit-content">
                  ...
                  {event.execution && (
                    <div className="execution-proof">
                      ...
                      <span>
                        Receipt{" "}
                        <b>{event.execution.receiptVerified ? "Verified" : "Not verified"}</b>
                      </span>
                      ...
                      {event.execution.transactionHash && (
                        <span>
                          Transaction{" "}
                          <code>{shortAddress(event.execution.transactionHash, 10, 8)}</code>
                        </span>
                      )}
